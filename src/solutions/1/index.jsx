  ...
  return (
    <div>
      <article className={styles.Card}>
        ...
        >
          Bees are insects with wings closely related to wasps and ants, known
          ...
          known species of bees in seven recognized biological families.[1][2]
          Some species – including honey bees, bumblebees, and stingless bees –
          live socially in colonies while most species (>90%) – including mason
